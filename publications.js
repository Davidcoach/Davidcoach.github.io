const publications = [
    {
        image: "images/flows/nichedesig.png",
        title: "NicheDeSig: Niche-aware Deconvolution and Adaptive Signature Analysis for Spatial Transcriptomics",
        authors: "<strong>Wen Xue</strong>, Juncheng Zhang, Tianyi Chen, Wenjun Shen, Jinjin Ma, Yong Xu, Hau-San Wong, Si Wu",
        venue: "Bioinformatics",
        shortVenue: "Bioinformatics 2026",
        highlighted: true,
        year: 2026,
        links: [
            { label: "Paper", url: "papers/NicheDeSig_Bioinformatics_2026.pdf" },
            { label: "Code", url: "https://github.com/Davidcoach/NicheDeSig" }
        ],
        badge: "First author · CCF-A · SCI Q1",
        description: "Introduces a niche-aware spatial transcriptomics deconvolution framework that jointly estimates spot-level cell-type proportions and learns adaptive cell-type signatures, revealing niche-dependent molecular programs across tissue microenvironments.",
        descriptionZh: "提出面向空间转录组的生态位感知解卷积框架，在估计空间点位细胞类型比例的同时学习自适应细胞类型特征，解析不同组织微环境中的生态位依赖分子程序。",
        selected: true,
        primaryTopic: "Computational Biology",
        contribution: "lead",
        topics: ["Computational Biology"]
    },
    {
        image: "images/flows/diffbpm.png",
        title: "Diffusion-based Blemish Prior with Statistical Modulation for High-fidelity Face Retouching",
        authors: "Bingbing Zheng*, <strong>Wen Xue*</strong>, Lianxin Xie, Si Wu",
        venue: "Neurocomputing",
        shortVenue: "Neurocomputing 2026",
        highlighted: true,
        year: 2026,
        links: [
            { label: "Paper", url: "papers/DiffBPM_Neurocomputing_2026.pdf" },
            { label: "DOI", url: "https://doi.org/10.1016/j.neucom.2026.134713" }
        ],
        badge: "Co-first author · SCI Q1",
        description: "Introduces DiffBPM, combining diffusion-based blemish priors with blemish-aware statistical modulation to localize diverse facial imperfections and transfer surrounding clean-skin statistics for natural, texture-preserving retouching.",
        descriptionZh: "提出 DiffBPM，将扩散式瑕疵先验与瑕疵感知统计调制相结合，精准定位多样面部瑕疵，并利用周围洁净皮肤的统计信息实现自然、保纹理的人脸精修。",
        selected: true,
    ...
    },
    {
        ...
        badge: "Co-first author · <strong>Oral Paper</strong> · CCF-A",
